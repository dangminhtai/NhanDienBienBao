...
7. **[DAT001] Tự động hóa Negative Mining:** 
...
8. **[HOG001] Đa tỷ lệ (Pyramid) hoặc ROI Scaling:**
...
9. **[SVM001] Tối ưu SVM chuyên sâu (Progressive GridSearch):** 
...
10. **[EVAL001] Precision-Recall Curve:** 
...
11. **[PROPOSAL001] Hình thái học Thích nghi (Adaptive Morphology):** 
...
12. **[COLOR001] Kiểm nghiệm Normalized RGB cho vùng có bóng đổ (Shadow Detection):** 
...
13. **[MSER001] Tích hợp bộ dò MSER cho phát hiện xa (High Resolution):** 
...
14. **[UI001] Giao diện Tương tác nâng cao (UI/UX):** 
...
15. **[UI002] Tối ưu hóa không gian hiển thị (Space Optimization):** 
...
16. **[UI003] Cơ chế xử lý lỗi đồ họa (Robust Rendering):** 
...
17. **[AI001] Chế độ Chồng lớp Kích hoạt (Activation Overlays):** 
...
18. **[AI002] Trực quan hóa 3D (3D Tensor Projection):** 
...
19. **[AI003] Phân tích cụm Đặc trưng (Feature Cluster Analysis):** 
...
20. **[AI004] Thử nghiệm Kích hoạt Nơ-ron (Neuron Probing):** 
...
21. **[UI004] Trực quan hóa Phép chuẩn hóa (Standardization Viz):** 
...
22. **[AI005] Trực quan hóa Siêu mặt phẳng SVM (SVM Decision Boundary):** 
...
23. **[AI006] Chiếu Tọa độ Thực (Real-time t-SNE Projection):** 
...
24. **[AI007] Hiệu chuẩn Thống kê (Platt Scaling):** 
...
25. **[UI006] So sánh Kernel Tương tác (Interactive Kernel Lab):** 
...
26. **[UI007] Chế độ Phân loại Đối tượng (Audience Switch):** 
...
27. **[UI008] Tùy chỉnh Siêu tham số (Interactive Hyperparameter Tuning):** 
...
28. **[UI009] Hoạt họa Bẻ cong Không gian (Space Bending Animation):** 
...
29. **[UI010] Cán cân Logic Tương tác (Interactive Logic Scale):** 
...
30. **[UI005] Khám phá Phân bổ (Distribution Explorer):** 
...
31. **[UI011] Đa ngôn ngữ & Tùy biến Nội dung (I18n & CMS):**
    - Tiếp tục hoàn thiện bộ gõ tiếng Việt trong `content.json` để đồng bộ toàn bộ Dashboard.
    - Hỗ trợ anh thay đổi "văn phong" giải thích (từ Hàn lâm sang Phổ thông) chỉ bằng một nút gạt.

32. **[PERF001] Đa luồng Video (Async Video Processing):**
    - Triển khai kiến trúc Producer-Consumer bằng `Queue` và `threading` để tách biệt luồng đọc khung hình và luồng xử lý AI, giúp UI Streamlit đạt mượt mà 30fps.

33. **[BATCH001] Xuất báo cáo CSV:**
    - Thêm nút "Tải báo cáo kết quả (.csv)" sau khi quét xong thư mục ở Chế độ Batch.
